...
This script trains and saves the Logistic Regression model for deployment
"""
...
def save_model_and_metadata(model, feature_names, scaler, performance_metrics):
    ...
    # Save to pickle file
    with open('deployment/heart_disease_model.pkl', 'wb') as f:
...
def main():
    ...
    # Evaluate model
    performance_metrics = evaluate_model(model, X_test_scaled, y_test)
    
    # Save model and metadata
    save_model_and_metadata(model, feature_names, scaler, performance_metrics)
